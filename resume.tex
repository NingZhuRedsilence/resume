...
\usepackage[margin=1.2in,top=1.in,right=0.6in,left=1.6in, bottom=1.2in]{geometry}
...
\bigskip
\mhead{Project \newline Experience}%
\emph{Vervet Monkey Alarm Classification} \hfill \href{https://github.com/tcya/Vervet-monkey-alarm-clustering}{github.com/tcya/Vervet-monkey-alarm-clustering}
\begin{itemize*}
  \item Verified the classical discovery of three types  of alarms in vervet monkey by unsupervised clustering  
\end{itemize*}
...
\emph{PISA Data Visualization} \hfill \href{https://github.com/tcya/PISA-visualization}{github.com/tcya/PISA-visualization}
\begin{itemize*}
...
\smallskip
\emph{Identifying Fraud from Enron Email} \hfill \href{https://github.com/tcya/Identify-Enron-Corporate-Fraud}{github.com/tcya/Identify-Enron-Corporate-Fraud}
\begin{itemize*}
...
\smallskip
\emph{Red Wine Study} \hfill \href{https://github.com/tcya/what-affects-red-wine-quality}{github.com/tcya/what-affects-red-wine-quality}
\begin{itemize*}
...
\smallskip
\emph{Houston Map Data Wrangling} \hfill \href{https://github.com/tcya/houston-mapdata-wrangling}{github.com/tcya/houston-mapdata-wrangling}
\begin{itemize*}
...
\smallskip
\emph{New York Subway Data Analysis} \hfill \href{https://github.com/tcya/new-york-subway-data-analysis}{github.com/tcya/new-york-subway-data-analysis}
\begin{itemize*}
...
\emph{Forum Data Analysis} \hfill \href{https://github.com/tcya/udacity-forum-hadoop-analysis}{github.com/tcya/udacity-forum-hadoop-analysis}
\begin{itemize*}
  \item Programmed some MapReduce codes for Hadoop to analyze the posts in Udacity's forum.
\end{itemize*}
